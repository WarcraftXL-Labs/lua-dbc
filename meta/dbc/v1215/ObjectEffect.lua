---@meta
-- Generated LuaLS annotations for ObjectEffect (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of ObjectEffect in build 12.1.5.69594.
---@class dbc.row.v1215.ObjectEffect : RowProxy
---@field ID integer
---@field Offset number[]
...
---@param value integer
---@return dbc.row.v1215.ObjectEffect self
...
---Table container for ObjectEffect (Build 12.1.5.69594).
---@class dbc.Table.v1215.ObjectEffect : DbcTable
---@field [integer] dbc.row.v1215.ObjectEffect
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v1215.ObjectEffect
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v1215.ObjectEffect|nil
...
---@return dbc.Query<dbc.row.v1215.ObjectEffect>
