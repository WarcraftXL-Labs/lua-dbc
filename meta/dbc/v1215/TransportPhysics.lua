---@meta
-- Generated LuaLS annotations for TransportPhysics (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of TransportPhysics in build 12.1.5.69594.
---@class dbc.row.v1215.TransportPhysics : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.TransportPhysics self
...
---Table container for TransportPhysics (Build 12.1.5.69594).
---@class dbc.Table.v1215.TransportPhysics : DbcTable
---@field [integer] dbc.row.v1215.TransportPhysics
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v1215.TransportPhysics
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v1215.TransportPhysics|nil
...
---@return dbc.Query<dbc.row.v1215.TransportPhysics>
