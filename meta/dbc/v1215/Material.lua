---@meta
-- Generated LuaLS annotations for Material (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of Material in build 12.1.5.69594.
---@class dbc.row.v1215.Material : RowProxy
---@field ID integer
---@field Flags integer
...
---@param value integer
---@return dbc.row.v1215.Material self
...
---Table container for Material (Build 12.1.5.69594).
---@class dbc.Table.v1215.Material : DbcTable
---@field [integer] dbc.row.v1215.Material
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.Material>
