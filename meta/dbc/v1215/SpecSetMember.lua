---@meta
-- Generated LuaLS annotations for SpecSetMember (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of SpecSetMember in build 12.1.5.69594.
---@class dbc.row.v1215.SpecSetMember : RowProxy
---@field ID integer
---@field ChrSpecializationID integer
---@field SpecSet integer
...
---@param value integer
---@return dbc.row.v1215.SpecSetMember self
...
---Gets the value of field 'SpecSet'.
---@return integer value
function row:GetSpecSet() end

---Sets the value of field 'SpecSet'.
---@param value integer
---@return dbc.row.v1215.SpecSetMember self
function row:SetSpecSet(value) end

---Table container for SpecSetMember (Build 12.1.5.69594).
---@class dbc.Table.v1215.SpecSetMember : DbcTable
---@field [integer] dbc.row.v1215.SpecSetMember
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.SpecSetMember>
