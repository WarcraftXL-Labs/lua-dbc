---@meta
-- Generated LuaLS annotations for ItemDisplayInfoModelMatRes (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of ItemDisplayInfoModelMatRes in build 12.1.5.69594.
---@class dbc.row.v1215.ItemDisplayInfoModelMatRes : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.ItemDisplayInfoModelMatRes self
...
---Gets the value of field 'ModelIndex'.
---@return integer value
function row:GetModelIndex() end

---Sets the value of field 'ModelIndex'.
---@param value integer
---@return dbc.row.v1215.ItemDisplayInfoModelMatRes self
function row:SetModelIndex(value) end
...
---Table container for ItemDisplayInfoModelMatRes (Build 12.1.5.69594).
---@class dbc.Table.v1215.ItemDisplayInfoModelMatRes : DbcTable
---@field [integer] dbc.row.v1215.ItemDisplayInfoModelMatRes
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v1215.ItemDisplayInfoModelMatRes
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v1215.ItemDisplayInfoModelMatRes|nil
...
---@return dbc.Query<dbc.row.v1215.ItemDisplayInfoModelMatRes>
