---@meta
-- Generated LuaLS annotations for CraftingDataItemQuality (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of CraftingDataItemQuality in build 12.1.5.69594.
---@class dbc.row.v1215.CraftingDataItemQuality : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.CraftingDataItemQuality self
...
---Table container for CraftingDataItemQuality (Build 12.1.5.69594).
---@class dbc.Table.v1215.CraftingDataItemQuality : DbcTable
---@field [integer] dbc.row.v1215.CraftingDataItemQuality
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v1215.CraftingDataItemQuality
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v1215.CraftingDataItemQuality|nil
...
---@return dbc.Query<dbc.row.v1215.CraftingDataItemQuality>
