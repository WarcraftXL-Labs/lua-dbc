---@meta
-- Generated LuaLS annotations for CinematicSequences (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of CinematicSequences in build 12.1.5.69594.
---@class dbc.row.v1215.CinematicSequences : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.CinematicSequences self
...
---Table container for CinematicSequences (Build 12.1.5.69594).
---@class dbc.Table.v1215.CinematicSequences : DbcTable
---@field [integer] dbc.row.v1215.CinematicSequences
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.CinematicSequences>
