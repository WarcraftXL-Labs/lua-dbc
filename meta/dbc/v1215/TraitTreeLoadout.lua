---@meta
-- Generated LuaLS annotations for TraitTreeLoadout (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of TraitTreeLoadout in build 12.1.5.69594.
---@class dbc.row.v1215.TraitTreeLoadout : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.TraitTreeLoadout self
...
---Table container for TraitTreeLoadout (Build 12.1.5.69594).
---@class dbc.Table.v1215.TraitTreeLoadout : DbcTable
---@field [integer] dbc.row.v1215.TraitTreeLoadout
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.TraitTreeLoadout>
