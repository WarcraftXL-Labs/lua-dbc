---@meta
-- Generated LuaLS annotations for ChrCustomizationGeoset (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of ChrCustomizationGeoset in build 12.1.5.69594.
---@class dbc.row.v1215.ChrCustomizationGeoset : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.ChrCustomizationGeoset self
...
---Table container for ChrCustomizationGeoset (Build 12.1.5.69594).
---@class dbc.Table.v1215.ChrCustomizationGeoset : DbcTable
---@field [integer] dbc.row.v1215.ChrCustomizationGeoset
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.ChrCustomizationGeoset>
