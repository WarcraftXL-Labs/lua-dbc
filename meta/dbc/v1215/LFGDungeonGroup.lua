---@meta
-- Generated LuaLS annotations for LFGDungeonGroup (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of LFGDungeonGroup in build 12.1.5.69594.
---@class dbc.row.v1215.LFGDungeonGroup : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.LFGDungeonGroup self
...
---Table container for LFGDungeonGroup (Build 12.1.5.69594).
---@class dbc.Table.v1215.LFGDungeonGroup : DbcTable
---@field [integer] dbc.row.v1215.LFGDungeonGroup
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v1215.LFGDungeonGroup
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v1215.LFGDungeonGroup|nil
...
---@return dbc.Query<dbc.row.v1215.LFGDungeonGroup>
