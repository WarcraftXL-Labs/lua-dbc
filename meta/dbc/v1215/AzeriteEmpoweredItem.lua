---@meta
-- Generated LuaLS annotations for AzeriteEmpoweredItem (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of AzeriteEmpoweredItem in build 12.1.5.69594.
---@class dbc.row.v1215.AzeriteEmpoweredItem : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.AzeriteEmpoweredItem self
...
---Table container for AzeriteEmpoweredItem (Build 12.1.5.69594).
---@class dbc.Table.v1215.AzeriteEmpoweredItem : DbcTable
---@field [integer] dbc.row.v1215.AzeriteEmpoweredItem
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v1215.AzeriteEmpoweredItem
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v1215.AzeriteEmpoweredItem|nil
...
---@return dbc.Query<dbc.row.v1215.AzeriteEmpoweredItem>
