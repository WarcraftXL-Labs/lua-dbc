---@meta
-- Generated LuaLS annotations for Spell (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of Spell in build 12.1.5.69594.
---@class dbc.row.v1215.Spell : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.Spell self
...
---Table container for Spell (Build 12.1.5.69594).
---@class dbc.Table.v1215.Spell : DbcTable
---@field [integer] dbc.row.v1215.Spell
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.Spell>
