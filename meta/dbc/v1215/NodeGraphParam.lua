---@meta
-- Generated LuaLS annotations for NodeGraphParam (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of NodeGraphParam in build 12.1.5.69594.
---@class dbc.row.v1215.NodeGraphParam : RowProxy
...
---@param value string
---@return dbc.row.v1215.NodeGraphParam self
...
---Table container for NodeGraphParam (Build 12.1.5.69594).
---@class dbc.Table.v1215.NodeGraphParam : DbcTable
---@field [integer] dbc.row.v1215.NodeGraphParam
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v1215.NodeGraphParam
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v1215.NodeGraphParam|nil
...
---@return dbc.Query<dbc.row.v1215.NodeGraphParam>
