---@meta
-- Generated LuaLS annotations for ItemSalvage (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of ItemSalvage in build 12.1.5.69594.
---@class dbc.row.v1215.ItemSalvage : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.ItemSalvage self
...
---Table container for ItemSalvage (Build 12.1.5.69594).
---@class dbc.Table.v1215.ItemSalvage : DbcTable
---@field [integer] dbc.row.v1215.ItemSalvage
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.ItemSalvage>
