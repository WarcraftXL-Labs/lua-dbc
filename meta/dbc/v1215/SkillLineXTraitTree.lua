---@meta
-- Generated LuaLS annotations for SkillLineXTraitTree (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of SkillLineXTraitTree in build 12.1.5.69594.
---@class dbc.row.v1215.SkillLineXTraitTree : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.SkillLineXTraitTree self
...
---Gets the value of field 'Variant'.
---@return integer value
function row:GetVariant() end

---Sets the value of field 'Variant'.
---@param value integer
---@return dbc.row.v1215.SkillLineXTraitTree self
function row:SetVariant(value) end

---Table container for SkillLineXTraitTree (Build 12.1.5.69594).
---@class dbc.Table.v1215.SkillLineXTraitTree : DbcTable
---@field [integer] dbc.row.v1215.SkillLineXTraitTree
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v1215.SkillLineXTraitTree
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v1215.SkillLineXTraitTree|nil
...
---@return dbc.Query<dbc.row.v1215.SkillLineXTraitTree>
