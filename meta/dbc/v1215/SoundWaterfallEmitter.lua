---@meta
-- Generated LuaLS annotations for SoundWaterfallEmitter (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of SoundWaterfallEmitter in build 12.1.5.69594.
---@class dbc.row.v1215.SoundWaterfallEmitter : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.SoundWaterfallEmitter self
...
---Table container for SoundWaterfallEmitter (Build 12.1.5.69594).
---@class dbc.Table.v1215.SoundWaterfallEmitter : DbcTable
---@field [integer] dbc.row.v1215.SoundWaterfallEmitter
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v1215.SoundWaterfallEmitter
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v1215.SoundWaterfallEmitter|nil
...
---@return dbc.Query<dbc.row.v1215.SoundWaterfallEmitter>
