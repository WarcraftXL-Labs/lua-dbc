---@meta
-- Generated LuaLS annotations for Light (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of Light in build 12.1.5.69594.
---@class dbc.row.v1215.Light : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.Light self
...
---Table container for Light (Build 12.1.5.69594).
---@class dbc.Table.v1215.Light : DbcTable
---@field [integer] dbc.row.v1215.Light
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.Light>
