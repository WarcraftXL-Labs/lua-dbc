---@meta
-- Generated LuaLS annotations for EmotesText (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of EmotesText in build 12.1.5.69594.
---@class dbc.row.v1215.EmotesText : RowProxy
---@field ID integer
---@field Name string
...
---@param value integer
---@return dbc.row.v1215.EmotesText self
...
---Table container for EmotesText (Build 12.1.5.69594).
---@class dbc.Table.v1215.EmotesText : DbcTable
---@field [integer] dbc.row.v1215.EmotesText
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.EmotesText>
