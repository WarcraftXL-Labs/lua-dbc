---@meta
-- Generated LuaLS annotations for SpotLightConditionMap (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of SpotLightConditionMap in build 12.1.5.69594.
---@class dbc.row.v1215.SpotLightConditionMap : RowProxy
---@field ID integer
---@field MapID integer
...
---@param value integer
---@return dbc.row.v1215.SpotLightConditionMap self
...
---Table container for SpotLightConditionMap (Build 12.1.5.69594).
---@class dbc.Table.v1215.SpotLightConditionMap : DbcTable
---@field [integer] dbc.row.v1215.SpotLightConditionMap
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v1215.SpotLightConditionMap
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v1215.SpotLightConditionMap|nil
...
---@return dbc.Query<dbc.row.v1215.SpotLightConditionMap>
