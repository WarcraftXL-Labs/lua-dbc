---@meta
-- Generated LuaLS annotations for Lock (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of Lock in build 12.1.5.69594.
---@class dbc.row.v1215.Lock : RowProxy
---@field ID integer
---@field Flags integer &0x1: tooltip showing unlock vs open action?
...
---@param value integer
---@return dbc.row.v1215.Lock self
...
---Table container for Lock (Build 12.1.5.69594).
---@class dbc.Table.v1215.Lock : DbcTable
---@field [integer] dbc.row.v1215.Lock
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.Lock>
