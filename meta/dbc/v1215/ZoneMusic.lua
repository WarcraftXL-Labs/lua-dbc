---@meta
-- Generated LuaLS annotations for ZoneMusic (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of ZoneMusic in build 12.1.5.69594.
---@class dbc.row.v1215.ZoneMusic : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.ZoneMusic self
...
---Table container for ZoneMusic (Build 12.1.5.69594).
---@class dbc.Table.v1215.ZoneMusic : DbcTable
---@field [integer] dbc.row.v1215.ZoneMusic
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.ZoneMusic>
