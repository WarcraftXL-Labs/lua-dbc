---@meta
-- Generated LuaLS annotations for TaxiPathNode (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of TaxiPathNode in build 12.1.5.69594.
---@class dbc.row.v1215.TaxiPathNode : RowProxy
---@field Loc number[]
---@field ID integer
...
---@param value number[]
---@return dbc.row.v1215.TaxiPathNode self
...
---@return dbc.row.v1215.DepartureEvent|nil
function row:GetDepartureEvent() end

---Creates a related 'DepartureEvent' row and automatically links 'DepartureEventID'.
---@param data? table
---@return dbc.row.v1215.DepartureEvent
function row:CreateRelated(data) end

---Table container for TaxiPathNode (Build 12.1.5.69594).
---@class dbc.Table.v1215.TaxiPathNode : DbcTable
---@field [integer] dbc.row.v1215.TaxiPathNode
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v1215.TaxiPathNode
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v1215.TaxiPathNode|nil
...
---@return dbc.Query<dbc.row.v1215.TaxiPathNode>
