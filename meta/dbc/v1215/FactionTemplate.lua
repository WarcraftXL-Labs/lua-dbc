---@meta
-- Generated LuaLS annotations for FactionTemplate (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of FactionTemplate in build 12.1.5.69594.
---@class dbc.row.v1215.FactionTemplate : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.FactionTemplate self
...
---Table container for FactionTemplate (Build 12.1.5.69594).
---@class dbc.Table.v1215.FactionTemplate : DbcTable
---@field [integer] dbc.row.v1215.FactionTemplate
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.FactionTemplate>
