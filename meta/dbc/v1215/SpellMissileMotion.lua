---@meta
-- Generated LuaLS annotations for SpellMissileMotion (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of SpellMissileMotion in build 12.1.5.69594.
---@class dbc.row.v1215.SpellMissileMotion : RowProxy
---@field ID integer
---@field Name string
...
---@param value integer
---@return dbc.row.v1215.SpellMissileMotion self
...
---Table container for SpellMissileMotion (Build 12.1.5.69594).
---@class dbc.Table.v1215.SpellMissileMotion : DbcTable
---@field [integer] dbc.row.v1215.SpellMissileMotion
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.SpellMissileMotion>
