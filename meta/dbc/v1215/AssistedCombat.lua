---@meta
-- Generated LuaLS annotations for AssistedCombat (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of AssistedCombat in build 12.1.5.69594.
---@class dbc.row.v1215.AssistedCombat : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.AssistedCombat self
...
---Table container for AssistedCombat (Build 12.1.5.69594).
---@class dbc.Table.v1215.AssistedCombat : DbcTable
---@field [integer] dbc.row.v1215.AssistedCombat
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.AssistedCombat>
