---@meta
-- Generated LuaLS annotations for TotemCategory (Build 12.1.5.69594 [v1215]). Do not edit.

---Row representation of TotemCategory in build 12.1.5.69594.
---@class dbc.row.v1215.TotemCategory : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v1215.TotemCategory self
...
---Table container for TotemCategory (Build 12.1.5.69594).
---@class dbc.Table.v1215.TotemCategory : DbcTable
---@field [integer] dbc.row.v1215.TotemCategory
local tbl = {}
...
---@return dbc.Query<dbc.row.v1215.TotemCategory>
