---@meta
-- Generated LuaLS annotations for SpellDispelType (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of SpellDispelType in build 3.3.5.12340.
---@class dbc.row.v335.SpellDispelType : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v335.SpellDispelType self
...
---Table container for SpellDispelType (Build 3.3.5.12340).
---@class dbc.Table.v335.SpellDispelType : DbcTable
---@field [integer] dbc.row.v335.SpellDispelType
local tbl = {}
...
---@return dbc.Query<dbc.row.v335.SpellDispelType>
