---@meta
-- Generated LuaLS annotations for AnimationData (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of AnimationData in build 3.3.5.12340.
---@class dbc.row.v335.AnimationData : RowProxy
---@field ID integer
---@field Name string
...
---@param value integer
---@return dbc.row.v335.AnimationData self
...
---Gets the value of field 'Weaponflags'.
---@return integer value
function row:GetWeaponflags() end

---Sets the value of field 'Weaponflags'.
---@param value integer
---@return dbc.row.v335.AnimationData self
function row:SetWeaponflags(value) end

---Gets the value of field 'Bodyflags'.
---@return integer value
function row:GetBodyflags() end

---Sets the value of field 'Bodyflags'.
---@param value integer
---@return dbc.row.v335.AnimationData self
function row:SetBodyflags(value) end
...
---Table container for AnimationData (Build 3.3.5.12340).
---@class dbc.Table.v335.AnimationData : DbcTable
---@field [integer] dbc.row.v335.AnimationData
local tbl = {}
...
---@return dbc.Query<dbc.row.v335.AnimationData>
