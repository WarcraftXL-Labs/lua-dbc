---@meta
-- Generated LuaLS annotations for GMSurveySurveys (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of GMSurveySurveys in build 3.3.5.12340.
---@class dbc.row.v335.GMSurveySurveys : RowProxy
---@field ID integer
---@field Q integer[]
...
---@param value integer
---@return dbc.row.v335.GMSurveySurveys self
...
---Table container for GMSurveySurveys (Build 3.3.5.12340).
---@class dbc.Table.v335.GMSurveySurveys : DbcTable
---@field [integer] dbc.row.v335.GMSurveySurveys
local tbl = {}
...
---@return dbc.Query<dbc.row.v335.GMSurveySurveys>
