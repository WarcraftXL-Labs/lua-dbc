---@meta
-- Generated LuaLS annotations for SpellFocusObject (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of SpellFocusObject in build 3.3.5.12340.
---@class dbc.row.v335.SpellFocusObject : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v335.SpellFocusObject self
...
---Table container for SpellFocusObject (Build 3.3.5.12340).
---@class dbc.Table.v335.SpellFocusObject : DbcTable
---@field [integer] dbc.row.v335.SpellFocusObject
local tbl = {}
...
---@return dbc.Query<dbc.row.v335.SpellFocusObject>
