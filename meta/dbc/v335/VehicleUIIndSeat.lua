---@meta
-- Generated LuaLS annotations for VehicleUIIndSeat (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of VehicleUIIndSeat in build 3.3.5.12340.
---@class dbc.row.v335.VehicleUIIndSeat : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v335.VehicleUIIndSeat self
...
---Table container for VehicleUIIndSeat (Build 3.3.5.12340).
---@class dbc.Table.v335.VehicleUIIndSeat : DbcTable
---@field [integer] dbc.row.v335.VehicleUIIndSeat
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v335.VehicleUIIndSeat
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v335.VehicleUIIndSeat|nil
...
---@return dbc.Query<dbc.row.v335.VehicleUIIndSeat>
