---@meta
-- Generated LuaLS annotations for MovieVariation (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of MovieVariation in build 3.3.5.12340.
---@class dbc.row.v335.MovieVariation : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v335.MovieVariation self
...
---Table container for MovieVariation (Build 3.3.5.12340).
---@class dbc.Table.v335.MovieVariation : DbcTable
---@field [integer] dbc.row.v335.MovieVariation
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v335.MovieVariation
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v335.MovieVariation|nil
...
---@return dbc.Query<dbc.row.v335.MovieVariation>
