---@meta
-- Generated LuaLS annotations for Vehicle (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of Vehicle in build 3.3.5.12340.
---@class dbc.row.v335.Vehicle : RowProxy
---@field ID integer
---@field Flags integer
...
---@param value integer
---@return dbc.row.v335.Vehicle self
...
---Gets the value of field 'MsslTrgtTurnLingering'.
---@return number value
function row:GetMsslTrgtTurnLingering() end

---Sets the value of field 'MsslTrgtTurnLingering'.
---@param value number
---@return dbc.row.v335.Vehicle self
function row:SetMsslTrgtTurnLingering(value) end

---Gets the value of field 'MsslTrgtPitchLingering'.
---@return number value
function row:GetMsslTrgtPitchLingering() end

---Sets the value of field 'MsslTrgtPitchLingering'.
---@param value number
---@return dbc.row.v335.Vehicle self
function row:SetMsslTrgtPitchLingering(value) end

---Gets the value of field 'MsslTrgtMouseLingering'.
---@return number value
function row:GetMsslTrgtMouseLingering() end

---Sets the value of field 'MsslTrgtMouseLingering'.
---@param value number
---@return dbc.row.v335.Vehicle self
function row:SetMsslTrgtMouseLingering(value) end

---Gets the value of field 'MsslTrgtEndOpacity'.
---@return number value
function row:GetMsslTrgtEndOpacity() end

---Sets the value of field 'MsslTrgtEndOpacity'.
---@param value number
---@return dbc.row.v335.Vehicle self
function row:SetMsslTrgtEndOpacity(value) end

---Gets the value of field 'MsslTrgtArcSpeed'.
---@return number value
function row:GetMsslTrgtArcSpeed() end

---Sets the value of field 'MsslTrgtArcSpeed'.
---@param value number
---@return dbc.row.v335.Vehicle self
function row:SetMsslTrgtArcSpeed(value) end

---Gets the value of field 'MsslTrgtArcRepeat'.
---@return number value
function row:GetMsslTrgtArcRepeat() end

---Sets the value of field 'MsslTrgtArcRepeat'.
---@param value number
---@return dbc.row.v335.Vehicle self
function row:SetMsslTrgtArcRepeat(value) end

---Gets the value of field 'MsslTrgtArcWidth'.
---@return number value
function row:GetMsslTrgtArcWidth() end

---Sets the value of field 'MsslTrgtArcWidth'.
---@param value number
---@return dbc.row.v335.Vehicle self
function row:SetMsslTrgtArcWidth(value) end

---Gets the value of field 'MsslTrgtImpactRadius'.
---@return number[] value
function row:GetMsslTrgtImpactRadius() end

---Sets the value of field 'MsslTrgtImpactRadius'.
---@param value number[]
---@return dbc.row.v335.Vehicle self
function row:SetMsslTrgtImpactRadius(value) end

---Gets element at 1-based index in 'MsslTrgtImpactRadius'.
---@param index integer
---@return number value
function row:GetMsslTrgtImpactRadiusItem(index) end

---Gets the value of field 'MsslTrgtArcTexture'.
---@return string value
function row:GetMsslTrgtArcTexture() end

---Sets the value of field 'MsslTrgtArcTexture'.
---@param value string
---@return dbc.row.v335.Vehicle self
function row:SetMsslTrgtArcTexture(value) end

---Gets the value of field 'MsslTrgtImpactTexture'.
---@return string value
function row:GetMsslTrgtImpactTexture() end

---Sets the value of field 'MsslTrgtImpactTexture'.
---@param value string
---@return dbc.row.v335.Vehicle self
function row:SetMsslTrgtImpactTexture(value) end

---Gets the value of field 'MsslTrgtImpactModel'.
---@return string[] value
function row:GetMsslTrgtImpactModel() end

---Sets the value of field 'MsslTrgtImpactModel'.
---@param value string[]
---@return dbc.row.v335.Vehicle self
function row:SetMsslTrgtImpactModel(value) end

---Gets element at 1-based index in 'MsslTrgtImpactModel'.
---@param index integer
---@return string value
function row:GetMsslTrgtImpactModelItem(index) end
...
---Gets the value of field 'UiLocomotionType'.
---@return integer value
function row:GetUiLocomotionType() end

---Sets the value of field 'UiLocomotionType'.
---@param value integer
---@return dbc.row.v335.Vehicle self
function row:SetUiLocomotionType(value) end

---Gets the value of field 'MsslTrgtImpactTexRadius'.
---@return number value
function row:GetMsslTrgtImpactTexRadius() end

---Sets the value of field 'MsslTrgtImpactTexRadius'.
---@param value number
---@return dbc.row.v335.Vehicle self
function row:SetMsslTrgtImpactTexRadius(value) end
...
---Table container for Vehicle (Build 3.3.5.12340).
---@class dbc.Table.v335.Vehicle : DbcTable
---@field [integer] dbc.row.v335.Vehicle
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v335.Vehicle
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v335.Vehicle|nil
...
---@return dbc.Query<dbc.row.v335.Vehicle>
