---@meta
-- Generated LuaLS annotations for FootstepTerrainLookup (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of FootstepTerrainLookup in build 3.3.5.12340.
---@class dbc.row.v335.FootstepTerrainLookup : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v335.FootstepTerrainLookup self
...
---Table container for FootstepTerrainLookup (Build 3.3.5.12340).
---@class dbc.Table.v335.FootstepTerrainLookup : DbcTable
---@field [integer] dbc.row.v335.FootstepTerrainLookup
local tbl = {}
...
---@return dbc.Query<dbc.row.v335.FootstepTerrainLookup>
