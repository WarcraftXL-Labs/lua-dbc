---@meta
-- Generated LuaLS annotations for SpellMissile (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of SpellMissile in build 3.3.5.12340.
---@class dbc.row.v335.SpellMissile : RowProxy
---@field ID integer
---@field Flags integer
...
---@param value integer
---@return dbc.row.v335.SpellMissile self
...
---Table container for SpellMissile (Build 3.3.5.12340).
---@class dbc.Table.v335.SpellMissile : DbcTable
---@field [integer] dbc.row.v335.SpellMissile
local tbl = {}
...
---@return dbc.Query<dbc.row.v335.SpellMissile>
