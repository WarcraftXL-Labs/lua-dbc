---@meta
-- Generated LuaLS annotations for TaxiPath (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of TaxiPath in build 3.3.5.12340.
---@class dbc.row.v335.TaxiPath : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v335.TaxiPath self
...
---Table container for TaxiPath (Build 3.3.5.12340).
---@class dbc.Table.v335.TaxiPath : DbcTable
---@field [integer] dbc.row.v335.TaxiPath
local tbl = {}
...
---@return dbc.Query<dbc.row.v335.TaxiPath>
