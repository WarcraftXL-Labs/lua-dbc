---@meta
-- Generated LuaLS annotations for GMSurveyQuestions (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of GMSurveyQuestions in build 3.3.5.12340.
...
---@field [integer] dbc.row.v335.GMSurveyQuestions
local tbl = {}
...
---@return dbc.Query<dbc.row.v335.GMSurveyQuestions>
