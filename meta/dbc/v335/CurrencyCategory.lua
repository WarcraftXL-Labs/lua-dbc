---@meta
-- Generated LuaLS annotations for CurrencyCategory (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of CurrencyCategory in build 3.3.5.12340.
---@class dbc.row.v335.CurrencyCategory : RowProxy
---@field ID integer
---@field Flags integer
...
---@param value integer
---@return dbc.row.v335.CurrencyCategory self
...
---Table container for CurrencyCategory (Build 3.3.5.12340).
---@class dbc.Table.v335.CurrencyCategory : DbcTable
---@field [integer] dbc.row.v335.CurrencyCategory
local tbl = {}
...
---@return dbc.Query<dbc.row.v335.CurrencyCategory>
