---@meta
-- Generated LuaLS annotations for CharacterFacialHairStyles (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of CharacterFacialHairStyles in build 3.3.5.12340.
---@class dbc.row.v335.CharacterFacialHairStyles : RowProxy
...
---@param value integer
---@return dbc.row.v335.CharacterFacialHairStyles self
...
---Table container for CharacterFacialHairStyles (Build 3.3.5.12340).
---@class dbc.Table.v335.CharacterFacialHairStyles : DbcTable
---@field [integer] dbc.row.v335.CharacterFacialHairStyles
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v335.CharacterFacialHairStyles
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v335.CharacterFacialHairStyles|nil
...
---@return dbc.Query<dbc.row.v335.CharacterFacialHairStyles>
