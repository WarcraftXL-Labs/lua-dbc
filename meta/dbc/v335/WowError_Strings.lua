---@meta
-- Generated LuaLS annotations for WowError_Strings (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of WowError_Strings in build 3.3.5.12340.
---@class dbc.row.v335.WowError_Strings : RowProxy
---@field ID integer
---@field Name string
...
---@param value integer
---@return dbc.row.v335.WowError_Strings self
...
---Table container for WowError_Strings (Build 3.3.5.12340).
---@class dbc.Table.v335.WowError_Strings : DbcTable
---@field [integer] dbc.row.v335.WowError_Strings
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v335.WowError_Strings
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v335.WowError_Strings|nil
...
---@return dbc.Query<dbc.row.v335.WowError_Strings>
