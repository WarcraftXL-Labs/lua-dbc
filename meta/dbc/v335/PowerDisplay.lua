---@meta
-- Generated LuaLS annotations for PowerDisplay (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of PowerDisplay in build 3.3.5.12340.
---@class dbc.row.v335.PowerDisplay : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v335.PowerDisplay self
...
---Table container for PowerDisplay (Build 3.3.5.12340).
---@class dbc.Table.v335.PowerDisplay : DbcTable
---@field [integer] dbc.row.v335.PowerDisplay
local tbl = {}
...
---@return dbc.Query<dbc.row.v335.PowerDisplay>
