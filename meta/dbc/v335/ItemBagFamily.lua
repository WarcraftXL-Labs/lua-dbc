---@meta
-- Generated LuaLS annotations for ItemBagFamily (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of ItemBagFamily in build 3.3.5.12340.
---@class dbc.row.v335.ItemBagFamily : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v335.ItemBagFamily self
...
---Table container for ItemBagFamily (Build 3.3.5.12340).
---@class dbc.Table.v335.ItemBagFamily : DbcTable
---@field [integer] dbc.row.v335.ItemBagFamily
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v335.ItemBagFamily
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v335.ItemBagFamily|nil
...
---@return dbc.Query<dbc.row.v335.ItemBagFamily>
