---@meta
-- Generated LuaLS annotations for LiquidType (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of LiquidType in build 3.3.5.12340.
---@class dbc.row.v335.LiquidType : RowProxy
---@field ID integer
---@field Name string
---@field Flags integer
...
---@param value integer
---@return dbc.row.v335.LiquidType self
...
---Table container for LiquidType (Build 3.3.5.12340).
---@class dbc.Table.v335.LiquidType : DbcTable
---@field [integer] dbc.row.v335.LiquidType
local tbl = {}
...
---@return dbc.Query<dbc.row.v335.LiquidType>
