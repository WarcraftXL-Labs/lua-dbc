---@meta
-- Generated LuaLS annotations for EnvironmentalDamage (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of EnvironmentalDamage in build 3.3.5.12340.
---@class dbc.row.v335.EnvironmentalDamage : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v335.EnvironmentalDamage self
...
---Table container for EnvironmentalDamage (Build 3.3.5.12340).
---@class dbc.Table.v335.EnvironmentalDamage : DbcTable
---@field [integer] dbc.row.v335.EnvironmentalDamage
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v335.EnvironmentalDamage
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v335.EnvironmentalDamage|nil
...
---@return dbc.Query<dbc.row.v335.EnvironmentalDamage>
