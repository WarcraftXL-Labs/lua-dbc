---@meta
-- Generated LuaLS annotations for HolidayDescriptions (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of HolidayDescriptions in build 3.3.5.12340.
---@class dbc.row.v335.HolidayDescriptions : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v335.HolidayDescriptions self
...
---Table container for HolidayDescriptions (Build 3.3.5.12340).
---@class dbc.Table.v335.HolidayDescriptions : DbcTable
---@field [integer] dbc.row.v335.HolidayDescriptions
local tbl = {}
...
---@return dbc.Query<dbc.row.v335.HolidayDescriptions>
