---@meta
-- Generated LuaLS annotations for TerrainType (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of TerrainType in build 3.3.5.12340.
---@class dbc.row.v335.TerrainType : RowProxy
...
---Gets the value of field 'TerrainID'.
---@return integer value
function row:GetTerrainID() end

---Sets the value of field 'TerrainID'.
---@param value integer
---@return dbc.row.v335.TerrainType self
function row:SetTerrainID(value) end

---Navigates foreign relationship to 'Terrain' via 'TerrainID'.
---@return dbc.row.v335.Terrain|nil
function row:GetTerrain() end

---Creates a related 'Terrain' row and automatically links 'TerrainID'.
---@param data? table
---@return dbc.row.v335.Terrain
...
---Table container for TerrainType (Build 3.3.5.12340).
---@class dbc.Table.v335.TerrainType : DbcTable
---@field [integer] dbc.row.v335.TerrainType
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v335.TerrainType
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v335.TerrainType|nil
...
---@return dbc.Query<dbc.row.v335.TerrainType>
