---@meta
-- Generated LuaLS annotations for EmotesTextSound (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of EmotesTextSound in build 3.3.5.12340.
---@class dbc.row.v335.EmotesTextSound : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v335.EmotesTextSound self
...
---Table container for EmotesTextSound (Build 3.3.5.12340).
---@class dbc.Table.v335.EmotesTextSound : DbcTable
---@field [integer] dbc.row.v335.EmotesTextSound
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v335.EmotesTextSound
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v335.EmotesTextSound|nil
...
---@return dbc.Query<dbc.row.v335.EmotesTextSound>
