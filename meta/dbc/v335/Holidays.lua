---@meta
-- Generated LuaLS annotations for Holidays (Build 3.3.5.12340 [v335]). Do not edit.

---Row representation of Holidays in build 3.3.5.12340.
---@class dbc.row.v335.Holidays : RowProxy
---@field ID integer
...
---@param value integer
---@return dbc.row.v335.Holidays self
...
---@return dbc.row.v335.HolidayDescriptions|nil
...
---@param data? table
---@return dbc.row.v335.HolidayDescriptions
function row:CreateRelated(data) end
...
---Table container for Holidays (Build 3.3.5.12340).
---@class dbc.Table.v335.Holidays : DbcTable
---@field [integer] dbc.row.v335.Holidays
local tbl = {}

---Creates and appends a new row to the table.
---@param id? integer Primary key
---@param data? table Optional initial values
---@return dbc.row.v335.Holidays
function tbl:Create(id, data) end

---Finds a row by primary key (nil if not found).
---@param id integer
---@return dbc.row.v335.Holidays|nil
...
---@return dbc.Query<dbc.row.v335.Holidays>
