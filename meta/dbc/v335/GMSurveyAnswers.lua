...
---@field Answer string Localized string alias without _lang.
...
---Gets the localized value of field 'Answer'.
...
---@return string value
function row:GetAnswer(locale) end

---Sets the localized value of field 'Answer'.
